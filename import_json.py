...
class BotanyGraph:
    ...
    # 创建分类的各级结点
    def create_family_nodes(self, kindom_nodes, phylum_nodes, class_nodes, order_nodes, family_nodes, genus_nodes):
        kindom_nodes = list(set(kindom_nodes))
        ...
        self.create_node('Kindom', kindom_nodes)
    ...
    # 创建分类的各级节点之间的关系
    def create_family_relationship(self, rel_genus_family, rel_family_order, rel_order_class, rel_class_phylum, rel_phylum_kindom):
        ...
        self.create_rel_edge('Phylum', 'Kindom', rel_phylum_kindom, 'subclass_of', '属于')
        return
    ...
    def create_plant_node(self, species_nodes, all_property):
        ...
        for species_name, property_dict in zip(species_nodes, all_property):
            node = Node('Species', name=species_name, Chinese_name=property_dict['c_name'], common_name=property_dict['common_name'],
    ...
    def create_plant_family_relationship(self, rel_plant_kindom, rel_plant_phylum, rel_plant_class, rel_plant_order, rel_plant_family, rel_plant_genus):
        # self.create_rel_edge('Species', 'Kindom', rel_plant_kindom, 'type_of', '是一种')
            ...
            for species in all_info_dict:
                ...
                for property_key in info_dict:
                    ...
                    # 下面建立关系集
                        ...
                        kindom_nodes.append(c_family_dict['界'])
                        ...
                        rel_phylum_kindom.append([c_family_dict['门'], c_family_dict['界']])

                        rel_plant_kindom.append([species, c_family_dict['界']])
                        ...
                        if distribution_list:
                            for location in distribution_list:
                                ...
                                elif location in self.country:
                                    rel_plant_country.append([species, location])
                                else:
                                    rel_plant_area.append([species, location])
                all_property.append(property_dict)
        
        return (kindom_nodes, phylum_nodes, class_nodes, order_nodes, family_nodes, genus_nodes,
                species_nodes, all_property, rel_genus_family, rel_family_order, rel_order_class,
                rel_class_phylum, rel_phylum_kindom, rel_plant_kindom, rel_plant_phylum, rel_plant_class,
                rel_plant_order, rel_plant_family, rel_plant_genus, rel_plant_country, rel_plant_province,
                rel_plant_area)
    
    def build_graph(self):
        (kindom_nodes, phylum_nodes, class_nodes, order_nodes, family_nodes, genus_nodes,
                species_nodes, all_property, rel_genus_family, rel_family_order, rel_order_class,
                rel_class_phylum, rel_phylum_kindom, rel_plant_kindom, rel_plant_phylum, rel_plant_class,
                rel_plant_order, rel_plant_family, rel_plant_genus, rel_plant_country, rel_plant_province,
                rel_plant_area) = self.read_json()
        # 第一步，先创建结点
        self.create_distribution_nodes_and_relations()
        self.create_plant_node(species_nodes, all_property)
        self.create_family_nodes(kindom_nodes, phylum_nodes, class_nodes, order_nodes, family_nodes, genus_nodes)
        
        # 第二步，创建关系
        self.create_plant_distribution_relationship(rel_plant_country, rel_plant_province, rel_plant_area)
        self.create_plant_family_relationship(rel_plant_kindom, rel_plant_phylum, rel_plant_class, rel_plant_order, rel_plant_family, rel_plant_genus)
        self.create_family_relationship(rel_genus_family, rel_family_order, rel_order_class, rel_class_phylum, rel_phylum_kindom)
    
    def clear_graph(self):
        # 最先，必须清空整个图
        print('Clear all nodes and edges.')
